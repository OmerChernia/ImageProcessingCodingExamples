...
export default function BrightnessPage() {
  ...
  const handleImageUpload = async (file) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8000/api/brightness', {
        method: 'POST',
        body: formData,
      });
  ...
  const handleDownload = () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `${originalName}_brightness_${brightness}.png`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-8">
      <div className="container mx-auto px-4 max-w-7xl">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Brightness Adjustment</h1>
