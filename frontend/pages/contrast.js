...
export default function ContrastPage() {
  ...
  const handleImageSelect = async (e) => {
    ...
    if (file) {
      ...
      try {
        ...
        setOriginalHistogram(data.data);
      } catch (error) {
  ...
  const handleDownload = () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `${originalName}_contrast_${contrast.toFixed(1)}.png`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-8">
      <div className="container mx-auto px-4 max-w-7xl">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Contrast Stretching</h1>
            ...
            {selectedImage && (
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  />
                  <span className="text-sm text-gray-600 w-12 text-right">{contrast.toFixed(1)}</span>
                </div>
              </div>
            )}
        ...
        {/* Download Button - Below both images */}
        {processedImageUrl && (
          <div className="mt-4">
            <button
